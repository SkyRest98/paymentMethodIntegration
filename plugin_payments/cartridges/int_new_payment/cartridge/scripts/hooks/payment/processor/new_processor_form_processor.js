...
function processForm(req, paymentForm, viewFormData) {
    ...
    viewData.paymentInformation = {
        cardType: {
            value: paymentForm.newPaymentFields.cardType.value,
            htmlName: paymentForm.newPaymentFields.cardType.htmlName
        },
        cardNumber: {
            value: paymentForm.newPaymentFields.cardNumber.value,
            htmlName: paymentForm.newPaymentFields.cardNumber.htmlName
        },
        securityCode: {
            value: paymentForm.newPaymentFields.securityCode.value,
            htmlName: paymentForm.newPaymentFields.securityCode.htmlName
        },
        expirationMonth: {
            value: parseInt(
                paymentForm.newPaymentFields.expirationMonth.selectedOption,
                10
            ),
            htmlName: paymentForm.newPaymentFields.expirationMonth.htmlName
        },
        expirationYear: {
            value: parseInt(paymentForm.newPaymentFields.expirationYear.value, 10),
            htmlName: paymentForm.newPaymentFields.expirationYear.htmlName
        }
    };
    ...
    viewData.saveCard = paymentForm.newPaymentFields.saveCard.checked;
...
function savePaymentInformation(req, basket, billingData) {
    ...
    if (!billingData.storedPaymentUUID
        ...
        && (billingData.paymentMethod.value === 'NEW_PAYMENT')
    ) {
